...
// Temporary workaround to avoid merge conflicts.
// In a future you should be able to just define commands by exporting
// functions:
// exports.myCommand = function(env, args, request) { ... }
var canon = {
    addCommand: function (command) {
        exports[command.name] = command.exec;
    }
}
